...
public class HammerNailController1 : MonoBehaviour
{
    ...
    [SerializeField] public RevampedNailGame1 hammerMiniGame1;
    ...
    void Start()
    {
        if (gameManager != null)
        {
            ...
            hammerMiniGame1 = gameManager.GetComponent<RevampedNailGame1>();
            if (hammerMiniGame1 == null)
            {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity, nailLayer))
            {
                if (hit.collider != null && hit.collider.gameObject == gameObject)
                {
                    ...
                    if (hammerMiniGame1 != null)
                    {
                        ...
                        hammerMiniGame1.StartMinigame(gameObject);
                        HammeringNoise();
                    }
