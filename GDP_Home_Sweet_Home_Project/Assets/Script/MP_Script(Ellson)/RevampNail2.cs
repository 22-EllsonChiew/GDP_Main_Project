...
public class RevampNail2 : MonoBehaviour
{
    ...
    private HammerNailController2 currentNail;
    ...
    void Update()
    {
        if (isMinigameActive)
        {
            Ray ray = camRay3.ScreenPointToRay(Input.mousePosition);
    ...
    public void StartMinigame(GameObject nailPrefab)
    {
        ...
        currentNail = nailPrefab.GetComponent<HammerNailController2>();
