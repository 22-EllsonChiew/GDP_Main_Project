...
public class HammerNailController2 : MonoBehaviour
{
    ...
    [SerializeField] public RevampNail2 nail2;
    ...
    void Start()
    {
        if (gameManager != null)
        {
            ...
            nail2 = gameManager.GetComponent<RevampNail2>();
            if (nail2 == null)
            {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity, nailLayer))
            {
                if (hit.collider != null && hit.collider.gameObject == gameObject)
                {
                    ...
                    if (nail2 != null)
                    {
                        ...
                        nail2.StartMinigame(gameObject);
                        HammeringNoise();
                    }
